...
public class GridEnvironment implements Environment {
    ...
    GridEnvironment(String name, NavGrid grid, boolean[][] map) {
        ...
        dynamics = new GridDynamics(grid, map);
        representation = new GridRepresentation(grid);
    }
     ...
     */
    public void addGoal(final String name, final int row, final int column) {

        // Initialize reward function
        final double[] rewards = new double[grid.numStates()];
