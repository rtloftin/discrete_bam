 ...
 * given UNTIL a goal state (a state with non-zero reward)
 * is reached. The purpose of these experiments is to evaluate
 * ways in which we can deal with demonstrations that
 * end at the goal, which is what we get during the
 * human subjects experiments.
 */
public class MultiTaskGoalExperiment {
    ...
    public static class Builder {
        ...
        private boolean final_noop = false;
        ...
        public MultiTaskGoalExperiment build() {
            ...
            return new MultiTaskGoalExperiment(this);
        }
    }
    ...
    private MultiTaskGoalExperiment(Builder builder) {
    ...
    private Session session(Environment environment, Map<String, ExpertPolicy> experts, Algorithm algorithm) {
