 ...
 */
public class OldNormalizedActionModel implements ActionModel {

    private final double beta;

    private OldNormalizedActionModel(double beta) {
        this.beta = beta;
    }
    ...
    public static OldNormalizedActionModel get() {
        return new OldNormalizedActionModel(1.0);
    }

    public static OldNormalizedActionModel beta(double beta) {
        return new OldNormalizedActionModel(beta);
    }

    public static OldNormalizedActionModel load(JSONObject config) throws JSONException {
